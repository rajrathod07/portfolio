  ...
  return (
    <section className="relative w-full max-w-[1024px] mx-auto px-5 md:px-8 pt-2 pb-12 flex flex-col justify-start min-h-[calc(100vh-80px)]">
      ...
      <div className="hidden lg:flex absolute top-[48%] left-[55%] -translate-x-1/2 -translate-y-1/2 w-[110px] h-[110px] items-center justify-center z-30 pointer-events-none">
        ...
        <button onClick={(e) => handleScroll(e, 'work')} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[45px] h-[45px] bg-[#111] text-[#F5FF46] rounded-full flex flex-col items-center justify-center text-center border-[2px] border-[#EBE9E1] pointer-events-auto hover:scale-110 transition-transform shadow-[0_0_0_2px_#111] cursor-pointer">
